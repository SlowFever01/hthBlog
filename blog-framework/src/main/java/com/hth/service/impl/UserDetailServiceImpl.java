 ...
 */
//hth-blog的BlogLoginServiceImpl类封装好登录的用户名和密码之后，就会传到当前这个实现类
@Service
public class UserDetailServiceImpl implements UserDetailsService {

    @Autowired
    //UserMapper是我们在hth-framework工程mapper目录的接口
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        //返回查询到的用户信息。注意下面那行直接返回user会报错，我们需要在hth-framework工程的domain目录新
